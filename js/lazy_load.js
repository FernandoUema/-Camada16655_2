import{G as PaperRippleBehavior,H as IronMeta,I as I18nBehavior,a as assert,j as hexColorToSkColor,s as skColorToRgba,B as BackgroundSelectionType,N as NewTabPageProxy,F as FocusOutlineManager,E as EventTracker,f as assertNotReached,M as ModuleRegistry,n as ChromeCartProxy,y as createScrollBorders,C as CustomizeDialogPage,P as PromoBrowserCommandProxy,k as ImgElement,W as WindowProxy,h as hasKeyModifiers}from"./shared.rollup.js";import{Polymer,html,dom,PolymerElement,mixinBehaviors}from"chrome://resources/polymer/v3_0/polymer/polymer_bundled.min.js";import"chrome://new-tab-page/strings.m.js";import{loadTimeData}from"chrome://resources/js/load_time_data.m.js";import{SkColorSpec}from"chrome://resources/mojo/skia/public/mojom/skcolor.mojom-webui.js";import"chrome://resources/mojo/mojo/public/js/mojo_bindings_lite.js";import"chrome://resources/mojo/mojo/public/mojom/base/big_buffer.mojom-lite.js";import"chrome://resources/mojo/mojo/public/mojom/base/string16.mojom-lite.js";import"chrome://resources/mojo/mojo/public/mojom/base/time.mojom-lite.js";import"chrome://resources/mojo/skia/public/mojom/skcolor.mojom-lite.js";import"chrome://resources/mojo/url/mojom/url.mojom-lite.js";import"chrome://new-tab-page/realbox/realbox.mojom-lite.js";import{addSingletonGetter,isMac}from"chrome://resources/js/cr.m.js";import"chrome://resources/mojo/mojo/public/mojom/base/text_direction.mojom-lite.js";import"chrome://new-tab-page/new_tab_page.mojom-lite.js";import"chrome://new-tab-page/modules/cart/chrome_cart.mojom-lite.js";import"chrome://new-tab-page/modules/drive/drive.mojom-lite.js";import"chrome://new-tab-page/modules/task_module/task_module.mojom-lite.js";import"chrome://new-tab-page/promo_browser_command.mojom-lite.js";import{mojo}from"chrome://resources/mojo/mojo/public/js/bindings.js";// Copyright 2017 The Chromium Authors. All rights reserved.
...
Polymer({is:"managed-dialog",_template:html`<!--css-build:shadow--><!--_html_template_start_--><style scope="managed-dialog">iron-icon {
...
<!--_html_template_end_-->`,behaviors:[I18nBehavior],properties:{title:String,body:String},onOkClick_(){this.$.dialog.close()}});// Copyright 2020 The Chromium Authors. All rights reserved.
...
<!--_html_template_end_-->`}static get properties(){return{customLinksEnabled_:Boolean,hide_:Boolean}}constructor(){super();const{callbackRouter:callbackRouter,handler:handler}=NewTabPageProxy.getInstance();this.callbackRouter_=callbackRouter;this.pageHandler_=handler;this.setMostVisitedInfoListenerId_=null}connectedCallback(){super.connectedCallback();this.setMostVisitedInfoListenerId_=this.callbackRouter_.setMostVisitedInfo.addListener((info=>{this.customLinksEnabled_=info.customLinksEnabled;this.hide_=!info.visible}));this.pageHandler_.updateMostVisitedInfo();FocusOutlineManager.forDocument(document)}disconnectedCallback(){super.disconnectedCallback();this.callbackRouter_.removeListener(assert(this.setMostVisitedInfoListenerId_))}apply(){this.pageHandler_.setMostVisitedSettings(this.customLinksEnabled_,!this.hide_)}getCustomLinksAriaPressed_(){return!this.hide_&&this.customLinksEnabled_?"true":"false"}getCustomLinksSelected_(){return!this.hide_&&this.customLinksEnabled_?"selected":""}getHideClass_(){return this.hide_?"selected":""}getMostVisitedAriaPressed_(){return!this.hide_&&!this.customLinksEnabled_?"true":"false"}getMostVisitedSelected_(){return!this.hide_&&!this.customLinksEnabled_?"selected":""}onCustomLinksClick_(){if(!this.customLinksEnabled_){this.pageHandler_.onCustomizeDialogAction(newTabPage.mojom.CustomizeDialogAction.kShortcutsCustomLinksClicked)}this.customLinksEnabled_=true;this.hide_=false}onHideChange_(e){this.pageHandler_.onCustomizeDialogAction(newTabPage.mojom.CustomizeDialogAction.kShortcutsVisibilityToggleClicked);this.hide_=e.detail}onMostVisitedClick_(){if(this.customLinksEnabled_){this.pageHandler_.onCustomizeDialogAction(newTabPage.mojom.CustomizeDialogAction.kShortcutsMostVisitedClicked)}this.customLinksEnabled_=false;this.hide_=false}}customElements.define(CustomizeShortcutsElement.is,CustomizeShortcutsElement);// Copyright 2018 The Chromium Authors. All rights reserved.
